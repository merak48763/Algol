...
This project contains datapacks that implements some frequently-used features in Minecraft maps (mainly CTM).  
...
> [!IMPORTANT]
> The packs in this repository are maintained primarily for my own use.  
